...
public class UserServiceImpl implements UserService {
    ...
    public void deactivateUser(Integer id) {
        ...
        boolean hasBorrowedBooks = borrowRecordRepository.existsByBorrowRequestDetail_BorrowRequest_User_IdAndStatusIn(id, List.of(BorrowRecordStatus.BORROWED, BorrowRecordStatus.OVERDUE));
